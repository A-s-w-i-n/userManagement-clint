...
<button  style={{ position: 'relative', left: 20 }}>Add User</button>
    ...
    <tbody>
            ...
            {/* users.filter((user) =>
                user.username.toLowerCase().includes(query)).map((user, index) => { */}
                        ...
                        <tr >
                            <td> :<img src="https://static-00.iconduck.com/assets.00/profile-minor-icon-256x256-6u3v5w0z.png" alt="placehold" width={30} /></td>
